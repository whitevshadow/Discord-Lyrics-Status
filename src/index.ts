...
import { StatusChanger, pickEmojiForLyric } from "./StatusChanger"
...
function init(): void {
    ...
    lyricsFetcher.addSource(new GeniusSource())
    ...
    Current lyrics: ${playbackState.currentLine ? statusChanger.getStatusString(playbackState.currentLine) + " " + pickEmojiForLyric(playbackState.currentLine.text) : "Not available"}
