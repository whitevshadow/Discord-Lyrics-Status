...
function init() {
    ...
    lyricsFetcher.addSource(new GeniusSource_1.GeniusSource());
    ...
    Current lyrics: ${playbackState.currentLine ? statusChanger.getStatusString(playbackState.currentLine) + " " + (0, StatusChanger_1.pickEmojiForLyric)(playbackState.currentLine.text) : "Not available"}
